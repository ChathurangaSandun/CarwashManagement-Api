...
namespace CliveKumara.CarwashManagement.Api.Migrations
{
    ...
    [Migration("20200529054555_seed-locations")]
            ...
            modelBuilder.Entity("CliveKumara.CarwashManagement.Api.Models.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Color = "#ff8a65",
                            CreatedDate = new DateTime(2020, 5, 29, 13, 45, 54, 966, DateTimeKind.Local).AddTicks(8026),
                            Icon = "directions_car",
                            Image = "assets/images/banner3.jpg",
                            Name = "Car Wash",
                            Type = "CARWASH",
                            UpdatedDate = new DateTime(2020, 5, 29, 13, 45, 54, 967, DateTimeKind.Local).AddTicks(6495)
                        },
                        new
                        {
                            Id = 2L,
                            Color = "#5d6d7e",
                            CreatedDate = new DateTime(2020, 5, 29, 13, 45, 54, 968, DateTimeKind.Local).AddTicks(8179),
                            Icon = "directions_car",
                            Image = "assets/images/banner4.jpg",
                            Name = "Car Service",
                            Type = "CARSERVICE",
                            UpdatedDate = new DateTime(2020, 5, 29, 13, 45, 54, 968, DateTimeKind.Local).AddTicks(8193)
                        },
                        new
                        {
                            Id = 3L,
                            Color = "#a569bd",
                            CreatedDate = new DateTime(2020, 5, 29, 13, 45, 54, 968, DateTimeKind.Local).AddTicks(8311),
                            Icon = "directions_car",
                            Image = "assets/images/banner5.jpg",
                            Name = "Car Parts",
                            Type = "CARPARTS",
                            UpdatedDate = new DateTime(2020, 5, 29, 13, 45, 54, 968, DateTimeKind.Local).AddTicks(8314)
                        });
                });
            ...
            modelBuilder.Entity("CliveKumara.CarwashManagement.Api.Models.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Address = "Nugegoda",
                            CreatedDate = new DateTime(2020, 5, 29, 5, 45, 54, 969, DateTimeKind.Utc).AddTicks(710),
                            Lat = 79.86965f,
                            Long = 6.864756f,
                            Name = "Echo Zone - 3M Tint",
                            UpdatedDate = new DateTime(2020, 5, 29, 5, 45, 54, 969, DateTimeKind.Utc).AddTicks(714)
                        },
                        new
                        {
                            Id = 2L,
                            Address = "Colombo 6",
                            CreatedDate = new DateTime(2020, 5, 29, 5, 45, 54, 969, DateTimeKind.Utc).AddTicks(906),
                            Lat = 79.86487f,
                            Long = 6.87702f,
                            Name = "Alpine Car Wash",
                            UpdatedDate = new DateTime(2020, 5, 29, 5, 45, 54, 969, DateTimeKind.Utc).AddTicks(907)
                        },
                        new
                        {
                            Id = 3L,
                            Address = "Colombo",
                            CreatedDate = new DateTime(2020, 5, 29, 5, 45, 54, 969, DateTimeKind.Utc).AddTicks(929),
                            Lat = 79.79967f,
                            Long = 6.864813f,
                            Name = "Staford motors ",
                            UpdatedDate = new DateTime(2020, 5, 29, 5, 45, 54, 969, DateTimeKind.Utc).AddTicks(929)
                        });
                });
